...
func httpStatusFromCode(code int) int {
	...
	case constants.CodeConflict, constants.CodeDuplicateKey, constants.CodeUserEmailExists,
		...
		constants.CodeReviewDuplicate, constants.CodeReviewNotPending, constants.CodeReviewWindowClosed:
		return http.StatusConflict
	case constants.CodeForbidden, constants.CodeReviewForbidden:
